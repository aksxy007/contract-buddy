...
import { api, fetchUserContract } from "@/lib/api";
...
export default function UserContracts() {
  ...
  const handleDelete=async (id: string)=>{
    try {
      const response = await api.delete(`/contracts/delete-contract/${id}`)
      ...
      cell: ({ row }) => {
        ...
        return (
          <Badge
            ...
            variant={
              score > 75 ? "outline" : score < 50 ? "destructive" : "secondary"
            }
          >
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction onClick={()=>handleDelete(contract._id)}>Continue</AlertDialogAction>
                  </AlertDialogFooter>
                </AlertDialogContent>
              </AlertDialog>
            </DropdownMenuContent>
